...
Дати відвідувачу переглянути актуальний розклад групових тренувань на тиждень із фільтрацією за тренером або видом тренування, а також коротко пояснити, як записатись на тренування і як скасувати запис.
...
* **Блок фільтрів:** 2 випадні списки
  ...
  * ⚠️ **Фільтри взаємовиключні** — вибір конкретного значення в одному списку автоматично скидає інший назад у «Всі» (не можна фільтрувати одночасно і за тренером, і за видом тренування)
  * При виборі фільтра, якщо в поточному й наступному тижні немає жодного відповідного заняття, сторінка сама шукає найближчий тиждень із заняттями (у фоні, до ~12 тижнів вперед) і перемикає перегляд туди
...
* **Фільтри «Тренер» і «Вид тренування»** — значення списків **не окремий запит**, а збираються з унікальних тренерів/типів тренувань, які вже є у завантаженому тижні
...
* Власної форми запису на сторінці немає. Запис на тренування — через застосунок Fitcontrol, чат на сайті, Viber, Telegram або дзвінок адміністратора; скасування — аналогічно, через застосунок або дзвінок адміністратора
